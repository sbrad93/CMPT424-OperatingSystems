...
//
const APP_NAME: string    = "chaOS";   // can characterize my thoughts while completing this project ('kay-aas') or maybe the cha cha slide ('chaa-oh-ess'), either is fitting
const APP_VERSION: string = "3.1.4";   // 159265358979323846264338327950288419716, that's all I got
